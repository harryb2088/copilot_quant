...
class IBKRBrokerService:
    ...
    def connect(
        self, paper_trading: bool = True, use_gateway: bool = False, timeout: int = 30, retry_count: int = 3
    ) -> bool:
        """
        Connect to IBKR.
    ...
    def reconnect(self) -> bool:
        ...
        """
        return self.connect(paper_trading=self._paper_trading, use_gateway=self._use_gateway)
