...
def get_credentials():
    ...
    credentials = {"usernames": {auth_email: {"email": auth_email, "name": auth_name, "password": hashed_password}}}
...
def init_authentication():
    ...
    authenticator = stauth.Authenticate(credentials, "copilot_quant_platform", "auth_cookie", cookie_expiry_days=1)
