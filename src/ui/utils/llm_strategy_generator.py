...
class LLMStrategyGenerator:
    ...
    def _check_rate_limit(self, user_id: str = "default") -> Tuple[bool, str]:
        ...
        if user_id in self.rate_limit_tracker:
            self.rate_limit_tracker[user_id] = [ts for ts in self.rate_limit_tracker[user_id] if ts > hour_ago]
        else:
    ...
    def generate_strategy(self, user_description: str, user_id: str = "default") -> Dict:
        ...
        if not is_allowed:
            return {"success": False, "error": message, "strategy": None}
        ...
        try:
            ...
            return {"success": False, "error": f"Error generating strategy: {str(e)}", "strategy": None}
    ...
    def _generate_signals_from_description(self, description: str, strategy_type: str) -> List[Dict]:
        ...
        if "rsi" in description.lower():
            indicators.append({"type": "RSI", "period": 14, "overbought": 70, "oversold": 30})

        if "sma" in description.lower() or "moving average" in description.lower():
            indicators.append({"type": "SMA", "short_period": 20, "long_period": 50})
    ...
    def _extract_parameters(self, description: str) -> Dict:
        ...
        params = {"initial_capital": 100000, "position_size_pct": 10, "max_positions": 10}
    ...
    def refine_strategy(self, current_strategy: Dict, refinement_input: str, user_id: str = "default") -> Dict:
        """
        ...
        return {"success": True, "error": None, "strategy": refined_strategy}
