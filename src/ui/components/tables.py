...
def render_trade_log(trades_df):
    ...
    # Style the dataframe
    st.dataframe(trades_df, use_container_width=True, height=400, hide_index=True)
...
def render_trades_pnl_table(trades_pnl_df):
    ...
    st.dataframe(trades_pnl_df, use_container_width=True, height=400, hide_index=True)
