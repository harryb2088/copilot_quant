...
class TestLiveDataFeedAdapter(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.adapter = LiveDataFeedAdapter(paper_trading=True, enable_cache=True, cache_size=100)
    ...
    def test_get_historical_data_success(self):
        ...
        result = self.adapter.get_historical_data(symbol="AAPL", start_date=datetime(2024, 1, 1), interval="1d")
    ...
    def test_get_historical_data_not_connected_reconnects(self):
        ...
        mock_data = pd.DataFrame({"close": [100]}, index=pd.date_range("2024-01-01", periods=1))
    ...
    def test_get_historical_data_caches_data(self):
        ...
        mock_data = pd.DataFrame({"close": [100, 101, 102]}, index=pd.date_range("2024-01-01", periods=3))
    ...
    def test_get_historical_data_fallback_to_cache(self):
        ...
        mock_data = pd.DataFrame({"close": [100, 101]}, index=pd.date_range("2024-01-01", periods=2))
    ...
    def test_get_multiple_symbols(self):
        ...
        aapl_data = pd.DataFrame({"Close": [100, 101]}, index=pd.date_range("2024-01-01", periods=2))

        msft_data = pd.DataFrame({"Close": [200, 201]}, index=pd.date_range("2024-01-01", periods=2))
