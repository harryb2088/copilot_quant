...
from copilot_quant.brokers.position_manager import IBKRPositionManager, Position, PositionChange
...
class TestPosition(unittest.TestCase):
    ...
    def test_cost_basis_property(self):
        ...
        pos = Position(symbol="AAPL", quantity=100.0, avg_cost=150.0)
    ...
    def test_pnl_percentage_zero_cost_basis(self):
        ...
        pos = Position(symbol="AAPL", quantity=0.0, avg_cost=150.0, unrealized_pnl=1000.0)
...
class TestPositionChange(unittest.TestCase):
    ...
    def test_position_change_creation(self):
        ...
        change = PositionChange(
            timestamp=datetime.now(), symbol="AAPL", change_type="opened", previous_quantity=0.0, new_quantity=100.0
        )
