...
from tests.mocks.mock_ib import MarketOrder, MockIB, Stock  # noqa: E402
...
class TestIBKRBrokerInitialization:
    ...
    def test_initialization_custom_params(self, mock_ib_class):
        ...
        IBKRBroker = get_broker_class()
        broker = IBKRBroker(paper_trading=False, host="192.168.1.100", port=7496, client_id=5, use_gateway=True)
