...
class TestIBKRLiveDataFeed(unittest.TestCase):
    ...
    def test_initialization(self):
        ...
        self.mock_connection_manager_class.assert_called_with(
            paper_trading=True, host=None, port=None, client_id=None, use_gateway=False, auto_reconnect=True
        )

        # Test with custom parameters
        feed = IBKRLiveDataFeed(paper_trading=False, host="192.168.1.100", port=7496, client_id=5)
        self.assertEqual(feed.paper_trading, False)

        # Verify connection manager was created with custom params
        self.mock_connection_manager_class.assert_called_with(
            paper_trading=False, host="192.168.1.100", port=7496, client_id=5, use_gateway=False, auto_reconnect=True
        )
    ...
    def test_get_latest_price(self):
        ...
        # Setup latest data
        feed._latest_data["AAPL"] = {"last": 150.50, "bid": 150.45, "ask": 150.55}
    ...
    def test_get_latest_data(self):
        ...
        test_data = {"last": 150.50, "bid": 150.45, "ask": 150.55, "volume": 1000000}
