...
class TestOrderLogger(unittest.TestCase):
    ...
    def test_log_retry(self):
        ...
        order_record = OrderRecord(
            order_id=1, symbol="AAPL", action="BUY", total_quantity=100, order_type="MARKET", retry_count=1
        )
    ...
    def test_log_event_custom(self):
        ...
        # Should not raise errors
        self.logger.log_event("CUSTOM_EVENT", order_record, {"detail1": "value1", "detail2": 123})

    def test_logger_without_file_logging(self):
        """Test logger with file logging disabled"""
        logger = OrderLogger(log_to_file=False, log_to_console=False)
    ...
    def test_format_for_console(self):
        ...
        data = {"order_id": 1, "symbol": "AAPL", "action": "BUY", "quantity": 100, "price": 150.50, "status": "FILLED"}
