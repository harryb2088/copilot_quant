...
class TestLiveBrokerAdapter(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.adapter = LiveBrokerAdapter(paper_trading=True, commission_rate=0.001, slippage_rate=0.0005)
    ...
    def test_connect_syncs_positions(self):
        ...
        self.mock_broker.connect.return_value = True
        self.mock_broker.get_positions.return_value = [{"symbol": "AAPL", "position": 100, "avg_cost": 150.0}]
    ...
    def test_execute_market_order_buy(self):
        ...
        self.mock_broker.is_connected.return_value = True
        self.mock_broker.get_account_balance.return_value = {"BuyingPower": 100000.0}
    ...
    def test_execute_limit_order(self):
        ...
        order = Order(symbol="AAPL", quantity=10, order_type="limit", side="buy", limit_price=149.0)
    ...
    def test_check_buying_power_buy_sufficient(self):
        ...
        self.mock_broker.is_connected.return_value = True
        self.mock_broker.get_account_balance.return_value = {"BuyingPower": 10000.0}
    ...
    def test_check_buying_power_buy_insufficient(self):
        ...
        self.mock_broker.is_connected.return_value = True
        self.mock_broker.get_account_balance.return_value = {"BuyingPower": 1000.0}
    ...
    def test_get_cash_balance(self):
        ...
        self.mock_broker.is_connected.return_value = True
        self.mock_broker.get_account_balance.return_value = {"TotalCashValue": 50000.0}
    ...
    def test_get_account_value(self):
        ...
        self.mock_broker.is_connected.return_value = True
        self.mock_broker.get_account_balance.return_value = {"NetLiquidation": 100000.0}
    ...
    def test_sync_positions(self):
        ...
        self.mock_broker.is_connected.return_value = True
        self.mock_broker.get_positions.return_value = [
            {"symbol": "AAPL", "position": 100, "avg_cost": 150.0},
            {"symbol": "MSFT", "position": 50, "avg_cost": 300.0},
        ]
