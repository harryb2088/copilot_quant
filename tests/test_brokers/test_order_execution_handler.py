...
class TestOrderExecutionHandler(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.handler = OrderExecutionHandler(
            max_retries=3,
    ...
    def test_handle_fill_complete(self):
        ...
        # Handle fill
        success = self.handler.handle_fill(
            order_id=1,
            quantity=100,
            price=150.50,
            commission=1.0
    ...
    def test_handle_fill_partial(self):
        ...
        # First partial fill
        success1 = self.handler.handle_fill(
            order_id=1,
            quantity=50,
            price=150.00
        )
        ...
        # Second partial fill
        success2 = self.handler.handle_fill(
            order_id=1,
            quantity=50,
            price=151.00
        )
    ...
    def test_handle_error(self):
        ...
        # Handle error
        success = self.handler.handle_error(
            order_id=1,
            error_code=201,
    ...
    def test_get_all_orders(self):
        ...
        order1 = OrderRecord(order_id=1, symbol="AAPL", action="BUY", 
                           total_quantity=100, order_type="MARKET")
        order2 = OrderRecord(order_id=2, symbol="GOOGL", action="SELL", 
                           total_quantity=50, order_type="LIMIT", limit_price=140.0)
    ...
    def test_get_active_orders(self):
        ...
        order1 = OrderRecord(order_id=1, symbol="AAPL", action="BUY", 
                           ...
                           status=OrderStatus.SUBMITTED)
        order2 = OrderRecord(order_id=2, symbol="GOOGL", action="SELL", 
                           total_quantity=50, order_type="MARKET",
                           status=OrderStatus.FILLED)
        order3 = OrderRecord(order_id=3, symbol="MSFT", action="BUY", 
                           total_quantity=75, order_type="MARKET",
