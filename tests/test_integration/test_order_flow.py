...
from tests.mocks.mock_ib import MarketOrder, MockIB, Stock
...
class TestEndToEndOrderFlow:
    ...
    def test_complete_order_lifecycle(self, mock_ib_class):
        ...
        # Create broker
        broker = IBKRBroker(enable_account_manager=True, enable_position_manager=True, enable_order_execution=True)
        broker.connect()
