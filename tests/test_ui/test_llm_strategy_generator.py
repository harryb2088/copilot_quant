...
class TestLLMStrategyGenerator:
    ...
    def test_rate_limiting_blocks_excessive_requests(self):
        ...
        # Make max requests
        for _i in range(generator.max_requests_per_hour):
    ...
    def test_strategy_type_inference_momentum(self):
        ...
        momentum_inputs = ["A momentum strategy", "trend following approach", "breakout trading system"]
    ...
    def test_strategy_type_inference_mean_reversion(self):
        ...
        mean_reversion_inputs = ["mean reversion strategy", "reversion to the mean", "statistical mean reversion"]
