    ...
    def _run_loop(self) -> None:
        ...
        while self._running and not self._stop_event.is_set():
            try:
                ...
                self.errors.append({"timestamp": datetime.now(), "error": str(e), "type": type(e).__name__})
    ...
    def _execute_order(self, order: Order, timestamp: datetime) -> None:
        ...
        try:
            ...
            if fill:
                ...
                logger.info(f"✓ Order filled: {order.side} {order.quantity} {order.symbol} @ ${fill.fill_price:.2f}")
            else:
