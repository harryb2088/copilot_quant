...
class HealthMonitor:
    ...
    def check_connection(
        self, name: str, is_connected: bool, last_activity: Optional[datetime] = None, timeout_minutes: int = 5
    ) -> HealthCheck:
        """
        ...
        return HealthCheck(
            ...
            timestamp=datetime.now(),
            metadata={"connected": True, "last_activity": last_activity.isoformat() if last_activity else None},
        )

    def check_data_freshness(
        self, name: str, last_update: Optional[datetime], max_age_minutes: int = 15
    ) -> HealthCheck:
        """
