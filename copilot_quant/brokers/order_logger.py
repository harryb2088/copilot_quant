...
from .order_execution_handler import Fill, OrderRecord, OrderStatus
...
class OrderLogger:
    ...
    def __init__(self, log_to_file: bool = True, log_dir: Optional[str] = None, log_to_console: bool = True):
        """
    ...
    def log_status_change(self, order_record: OrderRecord, old_status: OrderStatus, new_status: OrderStatus):
        """
