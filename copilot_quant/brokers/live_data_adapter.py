...
class LiveDataFeedAdapter(IDataFeed):
    ...
    def __init__(
        ...
        self._live_feed = IBKRLiveDataFeed(
            paper_trading=paper_trading, host=host, port=port, client_id=client_id, use_gateway=use_gateway
        )
    ...
    def get_historical_data(
        ...
        try:
            ...
            df = self._live_feed.get_historical_bars(
                symbol=symbol, duration=duration, bar_size=bar_size, what_to_show="TRADES", use_rth=True
            )
    ...
    def get_ticker_info(self, symbol: str) -> Dict:
        ...
        Note:
            ...
            from IBKR if needed.
        """
        return {"symbol": symbol, "name": symbol, "exchange": "SMART", "currency": "USD", "type": "STOCK"}
    ...
    def _calculate_duration(self, start_date: Optional[datetime], end_date: Optional[datetime]) -> str:
        """
