...
class BenchmarkComparator:
    ...
    def compare_to_benchmark(
        self, portfolio_returns: pd.Series, benchmark: str = "SPY", risk_free_rate: float = 0.02
    ) -> Dict[str, Any]:
        """
        ...
        benchmark_returns = self._get_benchmark_returns(benchmark, start_date, end_date)
    ...
    def compare_to_multiple_benchmarks(
        self, portfolio_returns: pd.Series, benchmarks: List[str] = None, risk_free_rate: float = 0.02
        ...
        for benchmark in benchmarks:
            try:
                comparison = self.compare_to_benchmark(portfolio_returns, benchmark, risk_free_rate)
    ...
    def get_benchmark_equity_curve(
        self, benchmark: str, start_date: date, end_date: date, initial_value: float = 100000
    ) -> pd.Series:
        """
    ...
    def _get_benchmark_returns(self, benchmark: str, start_date: date, end_date: date) -> pd.Series:
