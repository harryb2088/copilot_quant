...
class PredictionMarketProvider(ABC):
    ...
    @abstractmethod
    def get_active_markets(self, category: Optional[str] = None, limit: Optional[int] = None) -> pd.DataFrame:
        """
...
class PolymarketProvider(PredictionMarketProvider):
    ...
    def __init__(self, rate_limit_delay: float = 0.5):
        ...
        self.session.headers.update({"User-Agent": "CopilotQuant/1.0", "Accept": "application/json"})
    ...
    def get_active_markets(self, category: Optional[str] = None, limit: Optional[int] = 100) -> pd.DataFrame:
        """
...
class KalshiProvider(PredictionMarketProvider):
    ...
    def __init__(self, api_key: Optional[str] = None, api_secret: Optional[str] = None, rate_limit_delay: float = 0.5):
        """
    ...
    def get_active_markets(self, category: Optional[str] = None, limit: Optional[int] = 100) -> pd.DataFrame:
        ...
        """
        try:
            params = {"status": "open", "limit": limit or 100}
...
def get_prediction_market_provider(provider_name: str, **kwargs) -> PredictionMarketProvider:
    """
